          ...
          <div class="table-responsive">
            <table class="table">
              ...
              <tbody>
                <?php
                  $grand_grand_total=0;
                  $cart_res = mysql_qres("SELECT c.ID as cart_ID,c.*,p.* FROM estore_cart as c join estore_product as p on c.p_id=p.ID where c.user_id = $user_id");
                      ...
                      <tr>
                        ...
                        <td class="cart-product-quantity">
                          <div class="quant-input">
                            <input readonly type="number" name="quantity" value="<?php echo $cart_qty?>">
                          </div>
                        </td>
