                      ...
                      <h5 class="card-title">Set a new Coupon Code</h5>
                        <form method="POST" enctype="multipart/form-data" >
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="coupon_code" placeholder="Enter Coupon code" class="form-control" id="coupon" />
                                <!-- <small id="random_number"></small> -->
                                <button class="btn btn-md btn-info mt-3" id="generate_string">Generate Random</button>
                            </div>
...
generateStringBtn.addEventListener('click', () => randomNumber.innerHTML = generateRandomString(8));
    ...
    <?php 
        ...
        if(isset($_GET['delete_id'])){
            ...
            deleterec('mart_coupon','ID',$delid,'couponcode.php');
