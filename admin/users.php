        ...
        if($_SERVER['REQUEST_METHOD'] === 'POST'){
           ...
           if(!empty($pass) && !empty($file_name)){
            ...
            if($file){
                ...
                $userUpdateSql = "UPDATE esotre_users SET username = '$name', email = '$email', pass = '$hasspass', address = '$address', photo = '$updatedname', phone = '$phone', status = '$status' WHERE ID = '$id'";
           ...
           if(empty($pass) && !empty($file_name)){
            ...
            if($file){
              ...
              $userUpdateSql = "UPDATE estore_user SET username = '$name', email = '$email',  address = '$address', photo = '$updatedname', phone = '$phone', status = '$status' WHERE ID = '$id'";
              $update_res = mysqli_query($db, $userUpdateSql);
              if($update_res){
                  header('location: users.php');
              }else{
