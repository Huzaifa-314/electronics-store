...
<main id="main" class="main">
    ...
    <section class="section">
        ...
        ?>
                                    ...
                                    ?>
                                        <tr>
                                            ...
                                            <td><?php
                                                ...
                                                echo $brand_name;
                                                ?></td>
                                            <td><?php echo ($stock == 0) ? "<span class=\"badge bg-danger\">Stock Out</sapn>" : $stock; ?></td>
                                            <td><?php
                                                if ($p_status == 0) {
            ...
            <?php
            if (isset($_GET['stock_out'])) {
            ?>
                <script>
                    document.addEventListener("DOMContentLoaded", function() {
                        const tableSearchInput = document.querySelector('.dataTable-input');

                        if (tableSearchInput) {
                            // Set the value of the input field
                            tableSearchInput.value = "Stock Out";
                            ...
                            tableSearchInput.dispatchEvent(inputEvent);

                            // Create and dispatch 'keydown' event for 'Enter' key
                            ...
                            tableSearchInput.dispatchEvent(enterEvent);

                            // Create and dispatch 'keyup' event for 'Enter' key
                            ...
                            tableSearchInput.dispatchEvent(keyupEvent);
                        } else {
                            console.error("Input field with class 'dataTable-input' not found.");
                        }
                    });
                </script>
