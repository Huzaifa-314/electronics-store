...
if($q == 1){
	// show products
	$products = mysqli_query($db,"SELECT * FROM `estore_product`");
...
if($q == 2){
	// show category
	$category_sql = "SELECT * FROM estore_category WHERE c_status='1'";
...
if($q == 3){
	// show brand
	$allBrandsSql = "SELECT * FROM estore_brand WHERE b_status = '1'";
